...
class CallbackModule(CallbackBase):
    ...
    def record_logs(self, execution_id, success=False):
        print "Inside the record_logs method"
        duration = self.logger.runtime
        print "==============================="
        print self.logger.log
        print self.logger.log_list
        print "==============================="
        db.ExecutionLogsDB().update_logs(execution_id, self.logger.log)
